...
quotationPaymentSchema.index({ quotationId: 1, createdAt: -1 });
quotationPaymentSchema.index({ quotationNumber: 1 });
quotationPaymentSchema.index({ customerId: 1 });
quotationPaymentSchema.index({ paymentMethod: 1 });
quotationPaymentSchema.index({ paymentStatus: 1 });
quotationPaymentSchema.index({ paymentDate: 1 });

export const QuotationPayment = mongoose.model<IQuotationPayment>('QuotationPayment', quotationPaymentSchema);
