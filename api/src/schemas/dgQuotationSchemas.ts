...
const baseItemSchema = Joi.object({
  ...
  kva: Joi.string().optional().trim().allow(''),
  phase: Joi.string().optional().trim().allow(''),
  annexureRating: Joi.string().optional().trim().allow(''),
  dgModel: Joi.string().optional().trim().allow(''),
  numberOfCylinders: Joi.number().optional(),
  subject: Joi.string().optional().trim().allow(''),
...
export const createDGQuotationSchema = Joi.object({
  ...
  validUntil: Joi.date().greater(Joi.ref('issueDate')).optional(),
  quotationRevisionNo: Joi.string().required().trim(),
  // DG Product Selection fields
  subject: Joi.string().optional().trim().allow(''),
  annexureRating: Joi.string().optional().trim().allow(''),
  dgModel: Joi.string().optional().trim().allow(''),
  cylinder: Joi.string().optional().trim().allow(''),
  // Warranty fields
  warrantyFromInvoice: Joi.string().optional().trim().allow(''),
  warrantyFromCommissioning: Joi.string().optional().trim().allow(''),
  warrantyHours: Joi.string().optional().trim().allow(''),
  // Terms & Conditions fields
  taxRate: Joi.string().optional().trim().allow(''),
  freightTerms: Joi.string().optional().trim().allow(''),
  deliveryPeriod: Joi.string().optional().trim().allow(''),
  validityDays: Joi.string().optional().trim().allow(''),
  ...
  dgSpecifications: Joi.object({
    ...
    quantity: Joi.number().positive().required(),
    segment: Joi.string().optional().trim().allow(''),
    subSegment: Joi.string().optional().trim().allow(''),
    dgOwnership: Joi.string().optional().trim().allow(''),
  ...
  location: Joi.string().optional().trim().allow(''),
  items: Joi.array().items(baseItemSchema).optional().default([]),
  dgItems: Joi.array().items(baseItemSchema).optional().default([]),
  ...
  grandTotalInWords: Joi.string().optional().trim().allow(''),
  notes: Joi.string().optional().allow(''),
  terms: Joi.string().optional().allow(''),
  validityPeriod: Joi.number().positive().optional().default(30),
