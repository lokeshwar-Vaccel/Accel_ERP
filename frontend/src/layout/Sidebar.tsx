...
import { useCurrentModulePermission } from '../hooks/useCurrentModulePermission';
import logo from '../assets/v_accel_logo.jpeg';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="relative pl-2 pt-1">
                ...
                >
                  <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-lg transform hover:scale-105 transition-transform duration-300 cursor-pointer overflow-hidden">
                    <img src={logo} alt="V-Accel ERP" className="w-6 h-6 object-contain" />
                  </div>
                </button>
                <div className="relative lg:hidden pl-2 pt-1">
                  <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-lg transform hover:scale-105 transition-transform duration-300 overflow-hidden">
                    <img src={logo} alt="V-Accel ERP" className="w-6 h-6 object-contain" />
                  </div>
                </div>
              </div>
