      ...
      <body>
        <div class="print-container">
          ...
          <div class="company-section">
            <div class="company-name">V-Accel ERP</div>
            ...
            <div class="address-section">
              <div class="address-block">
                ...
                <div class="address-content">
                  <p style="font-weight: bold;">Mahindra &amp; Mahindra Ltd</p>
                  <p>Farm Equipment Sector, Powerol Building</p>
                  <p>No.2, Akurli Road, Kandivali(East)</p>
                  <p>Mumbai - 400101</p>
                  <p>GSTIN/UIN: 27AAACM3025E1ZZ</p>
            ...
            <div class="bottom-row">
              ...
              <div class="right-section">
                <div class="signature-section">
                  <p style="font-weight: bold;">for V-Accel ERP</p>
