                ...
                filteredCustomers.map((customer) => (
                  <tr key={customer._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="space-y-1">
                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                          ...
                          customer.status === 'prospect' ? 'bg-orange-100 text-orange-800' :
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="space-y-1">
                        <div className="text-sm font-medium text-gray-900">
                          {customer.totalContracts || 0} contracts
                        </div>
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg max-w-md w-full">
            ...
            <p className="text-gray-600 mb-4">Customer creation form would go here...</p>
      ...
      {editingCustomer && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg max-w-md w-full">
            ...
            <p className="text-gray-600 mb-4">Customer editing form would go here...</p>
            <div className="flex space-x-4">
              <button
