...
export default function DGSales() {
  ...
  const [showOEMEditModal, setShowOEMEditModal] = useState(false);
  const [showOEMDeleteModal, setShowOEMDeleteModal] = useState(false);
  const [oemData, setOemData] = useState<any>(null);
  const [selectedOEM, setSelectedOEM] = useState<any>(null);
  const [oemFormData, setOemFormData] = useState<any>({
    companyName: '',
    contactPerson: '',
    email: '',
    phone: '',
    ...
    warrantyTerms: '12 months comprehensive warranty',
    creditLimit: 0,
    creditDays: 30,
    status: 'active',
    rating: 3,
  ...
  const openOEMCreateModal = () => {
    resetOEMForm();
    setShowOEMForm(true);
  };

  const openOEMEditModal = (oem: any) => {
    setSelectedOEM(oem);
    setOemFormData({
      oemCode: oem.oemCode,
      ...
      email: oem.email,
      phone: oem.phone,
      alternatePhone: oem.alternatePhone,
      address: oem.address,
      gstNumber: oem.gstNumber,
      ...
      creditLimit: oem.creditLimit,
      creditDays: oem.creditDays,
      status: oem.status,
      rating: oem.rating,
      notes: oem.notes
    });
    setShowOEMEditModal(true);
  };

  const openOEMViewModal = (oem: any) => {
    setSelectedOEM(oem);
    setShowOEMViewModal(true);
  };

  const openOEMDeleteModal = (oem: any) => {
    setSelectedOEM(oem);
    setShowOEMDeleteModal(true);
  };
  ...
  const handleOEMStatusUpdate = async (oemId: string, status: string) => {
    try {
  ...
  const handleOEMRatingUpdate = async (oemId: string, rating: number) => {
    try {
      await apiClient.dgSales.oems.updateRating(oemId, rating);
        ...
        return (
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow">
              <div className="p-6 border-b border-gray-200">
                <div className="flex justify-between items-center">
                  <h3 className="text-lg font-medium">OEM Suppliers</h3>
                  <div className="flex space-x-3">
                    <Input
                    ...
                    <Button onClick={openOEMCreateModal}>
                      <Plus className="h-4 w-4 mr-2" />
                      Add OEM
                    </Button>
                  </div>
              ...
              <Table
                ...
                data={oems.map(oem => ({
                  ...
                  contactPerson: oem.contactPerson || '',
                  phone: oem.phone || '',
                  products: oem.products ? `${oem.products.length} Products` : '0 Products',
                  rating: (
                      ...
                      {[1, 2, 3, 4, 5].map((star) => (
                        <Star
                          ...
                          className={`cursor-pointer ${
                            star <= (oem.rating || 0) ? 'text-yellow-400 fill-current' : 'text-gray-300'
                          }`}
                          onClick={() => handleOEMRatingUpdate(oem._id, star)}
                        />
                      ))}
                      <span className="ml-1 text-sm text-gray-600">({oem.rating || 0})</span>
                    </div>
                  ),
                  status: (
                    <Select
                      value={oem.status || 'active'}
                      onChange={(e) => handleOEMStatusUpdate(oem._id, e.target.value)}
                      options={[
                  ...
                  actions: (
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => openOEMDeleteModal(oem)}
  ...
  return (
    <div className="p-6">
      ...
      {/* OEM Create/Edit Modal */}
      {(showOEMForm || showOEMEditModal) && (
        <Modal
          isOpen={showOEMForm || showOEMEditModal}
          onClose={() => {
            setShowOEMForm(false);
            setShowOEMEditModal(false);
            resetOEMForm();
          }}
          title={showOEMForm ? 'Add New OEM' : 'Edit OEM'}
          size="xl"
        >
          <form onSubmit={handleOEMSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Select
                  value={oemFormData.status}
                  onChange={(value) => setOemFormData({ ...oemFormData, status: value })}
                  options={[
                    { value: 'active', label: 'Active' },
                    { value: 'inactive', label: 'Inactive' },
                    { value: 'blacklisted', label: 'Blacklisted' }
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Input
                    value={oemFormData.address.street}
                    onChange={(e) => setOemFormData({
                      ...oemFormData,
                ...
                <div>
                  ...
                  <Input
                    value={oemFormData.address.city}
                    onChange={(e) => setOemFormData({
                      ...oemFormData,
                ...
                <div>
                  ...
                  <Input
                    value={oemFormData.address.state}
                    onChange={(e) => setOemFormData({
                      ...oemFormData,
                ...
                <div>
                  ...
                  <Input
                    value={oemFormData.address.pincode}
                    onChange={(e) => setOemFormData({
                      ...oemFormData,
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Input
                    value={oemFormData.bankDetails.bankName}
                    onChange={(e) => setOemFormData({
                      ...oemFormData,
                ...
                <div>
                  ...
                  <Input
                    value={oemFormData.bankDetails.accountNo}
                    onChange={(e) => setOemFormData({
                      ...oemFormData,
                ...
                <div>
                  ...
                  <Input
                    value={oemFormData.bankDetails.ifsc}
                    onChange={(e) => setOemFormData({
                      ...oemFormData,
                ...
                <div>
                  ...
                  <Input
                    value={oemFormData.bankDetails.branch}
                    onChange={(e) => setOemFormData({
                      ...oemFormData,
            ...
            <div className="flex justify-end gap-4 pt-6 border-t">
              ...
              <Button type="submit">
                {showOEMForm ? 'Create OEM' : 'Update OEM'}
              </Button>
            </div>
          </form>
        </Modal>
      ...
      {/* OEM View Modal */}
      {showOEMViewModal && selectedOEM && (
        <Modal
          isOpen={showOEMViewModal}
          onClose={() => {
            setShowOEMViewModal(false);
            setSelectedOEM(null);
          }}
          title="OEM Details"
          size="xl"
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-900 font-medium">{selectedOEM.oemCode}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Company Name</label>
                <p className="text-gray-900">{selectedOEM.companyName}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Contact Person</label>
                <p className="text-gray-900">{selectedOEM.contactPerson}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Email</label>
                <p className="text-gray-900">{selectedOEM.email}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Phone</label>
                <p className="text-gray-900">{selectedOEM.phone}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Alternate Phone</label>
                <p className="text-gray-900">{selectedOEM.alternatePhone || 'N/A'}</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-gray-50 p-4 rounded-md">
                <p className="text-gray-900">
                  {selectedOEM.address.street}, {selectedOEM.address.city}, {selectedOEM.address.state} - {selectedOEM.address.pincode}
                </p>
                <p className="text-gray-600">{selectedOEM.address.country}</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-900">{selectedOEM.bankDetails.bankName}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Account Number</label>
                  <p className="text-gray-900">{selectedOEM.bankDetails.accountNo}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">IFSC Code</label>
                  <p className="text-gray-900">{selectedOEM.bankDetails.ifsc}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Branch</label>
                  <p className="text-gray-900">{selectedOEM.bankDetails.branch}</p>
                </div>
              </div>
            </div>
            ...
            {/* Products */}
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-4">Products ({selectedOEM.products?.length || 0})</h3>
              {selectedOEM.products && selectedOEM.products.length > 0 ? (
                <div className="space-y-4">
                  {selectedOEM.products.map((product: any, index: number) => (
                    <div key={product._id || index} className="border rounded-md p-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900">{product.kva}</p>
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">Phase</label>
                          <p className="text-gray-900">{product.phase}</p>
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">Fuel Type</label>
                          <p className="text-gray-900">{product.fuelType}</p>
                        </div>
                        <div>
                      ...
                      {product.specifications && (
                        <div className="mt-3">
                          ...
                          <p className="text-gray-900 text-sm">{product.specifications}</p>
                        </div>
                      )}
                    </div>
                  ))}
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-gray-900">{selectedOEM.paymentTerms}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Delivery Terms</label>
                    <p className="text-gray-900">{selectedOEM.deliveryTerms}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Warranty Terms</label>
                    <p className="text-gray-900">{selectedOEM.warrantyTerms}</p>
                  </div>
                </div>
              </div>
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-gray-900">₹{selectedOEM.creditLimit?.toLocaleString()}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Credit Days</label>
                    <p className="text-gray-900">{selectedOEM.creditDays} days</p>
                  </div>
                  <div>
                    ...
                    <div className="flex items-center gap-1">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <Star
                          ...
                          size={16}
                          className={`${
                            star <= (selectedOEM.rating || 0) ? 'text-yellow-400 fill-current' : 'text-gray-300'
                          }`}
                        />
                      ))}
                      <span className="ml-1 text-sm text-gray-600">({selectedOEM.rating || 0})</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {selectedOEM.notes && (
              <div>
                ...
                <p className="text-gray-900 bg-gray-50 p-3 rounded-md">{selectedOEM.notes}</p>
              </div>
            )}
      ...
      {/* OEM Delete Confirmation Modal */}
      {showOEMDeleteModal && selectedOEM && (
        <Modal
          isOpen={showOEMDeleteModal}
          onClose={() => {
            setShowOEMDeleteModal(false);
            setSelectedOEM(null);
          }}
        ...
        >
          <div className="space-y-4">
            <p className="text-gray-700">
              Are you sure you want to delete the OEM "{selectedOEM.companyName}"? This action cannot be undone.
            </p>
